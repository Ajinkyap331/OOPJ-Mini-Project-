export default class Data{
    static Starting = [0, 1, 1, 0, 0];
    static start = ["Is", "Does"];
    static Q = ["a boy", "age greator than 20", "have black hair", "fat", "Gujarati"];
    static YN = [[0, 1, 1, 0, 1], [1, 1, 1, 1, 1]];
    static Name = ["DAYA", "JETHALAL"];
    static Asked = Array(this.Q.length).fill(0)
    static fav = Array(this.Q.length).fill(0.0);
    static Final = [-1];
